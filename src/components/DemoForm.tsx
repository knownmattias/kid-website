  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-x-10 gap-y-8">
        <input
          type="text"
          placeholder={l === "sv" ? "Förnamn" : "First name"}
        ...
        <input
          type="text"
          placeholder={l === "sv" ? "Efternamn" : "Last name"}
          value={form.lastName}
      ...
      <div className="grid md:grid-cols-2 gap-x-10 gap-y-8">
        <input
          type="text"
          placeholder={l === "sv" ? "Företagsnamn" : "Company name"}
          value={form.company}
...
export const DemoBand = () => {
  ...
  return (
    <section id="demo" ref={ref} className="section-reveal bg-card py-24">
