---
title: "Avtalsförbindelse eller affärsförbindelse?"
category: "Beslut från FI"
excerpt: "Reflektioner kring tidpunkten kring kundriskbedömning med bakgrund i Finansinspektionens sanktionsbeslut mot Zettle."
date: "2025-10-27"
---
# Tidpunkt för kundriskbedömning och åtgärder för kundkännedom
...
![Abstrakt översikt av affärsrelation och dataflöden](/assets/insights/avtalsforbindelse-eller-affarsforbindelse/business-relationship.png)

```box
Läs beslutet mot Zimpler [här](https://www.fi.se/contentassets/0a296f43595d4e5c92dd78cf3ef3ddff/sanktionsbeslut-zimpler-ab.pdf). Zimpler fick en anmärkning och en sanktionsavgift på 3 miljoner kronor för överträdelser av penningtvättsreglerna.
```
...
![En schematisk överblick över när åtgärder för kundkännedom krävs](/assets/insights/avtalsforbindelse-eller-affarsforbindelse/schematic-overview-KYC.png)
...
## Tidpunkten för kundriskbedömning
...
![Överblick över den initiala kundriskbedömning](/assets/insights/avtalsforbindelse-eller-affarsforbindelse/schematic-overview-KYC-CRR.png)
## Faktorer att beakta i kundriskbedömningen
...
* Koppling till kryptotillgångssegmentet,
* Frågor från Polismyndigheten,
* Frekventa transaktioner,
* Transaktioner till höga belopp, och
* Stora utbetalningar till slutanvändare.
...
## Kan FI:s resonemang leda till att kundkännedom måste inhämtas redan när avtalet ingås?
...
![Schematisk överblick över en striktare tolkning av FI:s beslut](/assets/insights/avtalsforbindelse-eller-affarsforbindelse/schematic-overview-KYC-strict.png)
...
1. Om risken med kundrelationen är låg – i vilket fall förenklade åtgärder generellt får vidtas.
2. Om risken med kundrelationen är medelhög (normalrisk) och tjänsten har ett väl definierat och avgränsat användningsområde – i denna situation får antaganden vidtas trots att risken inte är låg.
...
## Vad innebär "väl definierad tjänst" och "avgränsat användningsområde"?
